...
```bash
# 查看系统状态
python momentum_main.py --status

# 处理单个ETF
python momentum_main.py -s 159915

# 批量处理指定门槛
python momentum_main.py -t 5000万门槛

# 双门槛处理(默认)
python momentum_main.py

# 限制处理数量
python momentum_main.py -t 3000万门槛 -n 10

# 清理缓存
python momentum_main.py --cleanup
```
...
**📊 系统状态**: ✅ 开发完成 | **🚀 实现状态**: 🎯 已完成 | **📅 最后更新**: 2025-07-30